...
typedef struct _SnapshotEntryMsg SnapshotEntryMsg;
typedef struct _WorkerStartupMsg WorkerStartupMsg;
...
typedef struct _LatencyStatsDelta LatencyStatsDelta;
...
typedef struct _SnapshotStateMsg SnapshotStateMsg;
...
typedef enum _WorkerStartupMsg__CONNTYPE {
  WORKER_STARTUP_MSG__CONN__TYPE__TCP = 0,
  WORKER_STARTUP_MSG__CONN__TYPE__UDP = 1,
  WORKER_STARTUP_MSG__CONN__TYPE__UNIX = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WORKER_STARTUP_MSG__CONN__TYPE)
...
struct  _SnapshotEntryMsg
{
  ProtobufCMessage base;
  uint32_t file_descriptor;
  char *file_name;
};
#define SNAPSHOT_ENTRY_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&snapshot_entry_msg__descriptor) \
    , 0, NULL }
 ...
 * WORKER_STARTUP 
 */
struct  _WorkerStartupMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData secmod_addr;
  uint32_t cmd_fd;
  uint32_t conn_fd;
  WorkerStartupMsg__CONNTYPE conn_type;
  char *remote_ip_str;
  char *our_ip_str;
  uint64_t session_start_time;
  ProtobufCBinaryData remote_addr;
  ProtobufCBinaryData our_addr;
  ProtobufCBinaryData sec_auth_init_hmac;
  size_t n_snapshot_entries;
  SnapshotEntryMsg **snapshot_entries;
  size_t n_pam_auth_group_list;
  char **pam_auth_group_list;
  size_t n_gssapi_auth_group_list;
  char **gssapi_auth_group_list;
  size_t n_plain_auth_group_list;
  char **plain_auth_group_list;
};
#define WORKER_STARTUP_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&worker_startup_msg__descriptor) \
    , {0,NULL}, 0, 0, WORKER_STARTUP_MSG__CONN__TYPE__TCP, NULL, NULL, 0, {0,NULL}, {0,NULL}, {0,NULL}, 0,NULL, 0,NULL, 0,NULL, 0,NULL }
 ...
 */
struct  _LatencyStatsDelta
{
  ProtobufCMessage base;
  uint64_t median_delta;
  uint64_t rms_delta;
  uint64_t sample_count_delta;
};
#define LATENCY_STATS_DELTA__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&latency_stats_delta__descriptor) \
    , 0, 0, 0 }
...
#define SEC_AUTH_INIT_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&sec_auth_init_msg__descriptor) \
    , 0, NULL, NULL, NULL, 0,NULL, NULL, 0u, NULL, NULL, NULL, NULL, NULL, 0, {0,NULL} }
...
#define SECM_SESSION_REPLY_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&secm_session_reply_msg__descriptor) \
    , AUTH__REP__OK, NULL, NULL, NULL, NULL, 0, {0,NULL}, 0, NULL, NULL, NULL, NULL }
 ...
 * snapshot_state 
 */
struct  _SnapshotStateMsg
{
  ProtobufCMessage base;
};
#define SNAPSHOT_STATE_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&snapshot_state_msg__descriptor) \
     }
...
typedef void (*UdpFdMsg_Closure)
                 (const UdpFdMsg *message,
                  void *closure_data);
typedef void (*SnapshotEntryMsg_Closure)
                 (const SnapshotEntryMsg *message,
                  void *closure_data);
typedef void (*WorkerStartupMsg_Closure)
                 (const WorkerStartupMsg *message,
                  void *closure_data);
...
typedef void (*BanIpReplyMsg_Closure)
                 (const BanIpReplyMsg *message,
                  void *closure_data);
typedef void (*LatencyStatsDelta_Closure)
                 (const LatencyStatsDelta *message,
                  void *closure_data);
...
typedef void (*SecmListCookiesReplyMsg_Closure)
                 (const SecmListCookiesReplyMsg *message,
                  void *closure_data);
typedef void (*SnapshotStateMsg_Closure)
                 (const SnapshotStateMsg *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor snapshot_entry_msg__descriptor;
extern const ProtobufCMessageDescriptor worker_startup_msg__descriptor;
extern const ProtobufCEnumDescriptor    worker_startup_msg__conn__type__descriptor;
...
extern const ProtobufCMessageDescriptor latency_stats_delta__descriptor;
...
extern const ProtobufCMessageDescriptor snapshot_state_msg__descriptor;
